...
{
    // Must match AnchorDTO in AnchorProvider.h
    ...
    internal class AnchorSubsystem : XRAnchorSubsystem
    {
        ...
        private class OpenXRProvider : Provider
        {
            ...
            public override bool TryAttachAnchor(TrackableId trackableToAffix, Pose pose, out XRAnchor anchor)
            {
                ...
                // This function is used to attach an anchor to a trackableId of a plane. We can revisit
                // implementing this function when we're hooking up plane finding.
                anchor = new XRAnchor();
                return false;
            }
