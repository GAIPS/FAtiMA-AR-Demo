...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    internal class HPMixedRealityControllerProfile : OpenXRInteractionFeature
    {
        ...
        public class HPMixedRealityController : XRControllerWithRumble
        {
            ...
            /// </summary>
            [Preserve, InputControl(offset = 96, aliases = new[] { "pointerPosition" })]
            ...
            /// </summary>
            [Preserve, InputControl(offset = 108, aliases = new[] { "pointerOrientation", "pointerRotation" })]
        ...
        /// <summary>
        /// Constant for a <see cref="ActionType.Axis1D"/> interaction binding '.../input/grip/pose' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs.
        /// </summary>
        ...
        /// <summary>
        /// Constant for a <see cref="ActionType.Axis2D"/> interaction binding '.../input/grip/pose' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs.
        /// </summary>
        public const string thumbstick = "/input/thumbstick";
        /// <summary>
        /// Constant for a <see cref="ActionType.Binary"/> interaction binding '.../input/grip/pose' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs.
        /// </summary>
        ...
        /// <summary>
        /// Constant for a <see cref="ActionType.Vibrate"/> interaction binding '.../input/grip/pose' OpenXR Input Binding. Used by <see cref="XrActionConfig"/> to bind actions to physical inputs.
        /// </summary>
