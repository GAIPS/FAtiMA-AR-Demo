    ...
    public class Hand
    {
        ...
        public void UpdateHandJoints(HandJointLocation[] locations)
        {
            ...
            foreach (HandJoint handJoint in HandJoints)
            {
                ...
                handJointGameObject.transform.SetPositionAndRotation(handJointLocation.Position, handJointLocation.Rotation);
                handJointGameObject.transform.localScale = new Vector3(handJointLocation.Radius, handJointLocation.Radius, handJointLocation.Radius);
            }
        }
